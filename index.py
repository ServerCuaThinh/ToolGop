...
"""
        ...
        print(f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mĐịa chỉ IP : {ip_address} ")
    else:
    ...
    if ip_address:
        ...
        if existing_key:
                ...
                if yeumoney_data.get('status') == "error":
                    ...
                    if link4m_response.status_code == 200:
                        ...
                        if link4m_data.get('status') == "error":
                            ...
                            print('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mLink Để Vượt Key Là:', link_key)  # Sử dụng dấu phẩy thay vì dấu cộng
                    else:
            ...
            while True:
                ...
                if keynhap == key:
                    print('\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  \033[1;32mKey Đúng Mời Bạn Dùng Tool')
                    sleep(2)
