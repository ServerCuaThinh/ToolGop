...
def idelay(delaymin, delaymax):
	...
	for demtg in range(int(delay), -1, -1):
		print(trang+"["+xanh+"Nam ~ Dev"+trang+"] ["+xanh+"L         "+trang+"] ["+xanh+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+cam+"Nam ~ Dev"+trang+"] ["+cam+"L"+xanh+"O        "+trang+"] ["+cam+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+blue+"Nam ~ Dev"+trang+"] ["+blue+"L"+xanh+"O"+cam+"A       "+trang+"] ["+blue+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+lam+"Nam ~ Dev"+trang+"] ["+lam+"L"+xanh+"O"+cam+"A"+blue+"D      "+trang+"] ["+lam+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+tim+"Nam ~ Dev"+trang+"] ["+tim+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I     "+trang+"] ["+tim+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+xnhac+"Nam ~ Dev"+trang+"] ["+xnhac+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N    "+trang+"] ["+xnhac+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+den+"Nam ~ Dev"+trang+"] ["+den+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G   "+trang+"] ["+den+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+do+"Nam ~ Dev"+trang+"] ["+do+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.  "+trang+"] ["+do+str(demtg)+trang+"]",end="     \r")
		sleep(0.2)
		print(trang+"["+vang+"Nam ~ Dev"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.. "+trang+"] ["+vang+str(demtg)+trang+"]",end="       \r")
		sleep(0.2)
		print(trang+"["+vang+"Nam ~ Dev"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G..."+trang+"] ["+vang+str(demtg)+trang+"]",end="      \r")
	print(trang+" ĐANG LÀM JOB TDS", end="                             \r")
def idelayblock(delay):
	for demtg in range(int(delay), -1, -1):
		print(trang+"["+xanh+"Nam ~ Dev"+trang+"] ["+xanh+"L         "+trang+"] [TIME_BLOCK] ["+xanh+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+cam+"Nam ~ Dev"+trang+"] ["+cam+"L"+xanh+"O        "+trang+"] [TIME_BLOCK] ["+cam+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+blue+"Nam ~ Dev"+trang+"] ["+blue+"L"+xanh+"O"+cam+"A       "+trang+"] [TIME_BLOCK] ["+blue+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+lam+"Nam ~ Dev"+trang+"] ["+lam+"L"+xanh+"O"+cam+"A"+blue+"D      "+trang+"] [TIME_BLOCK] ["+lam+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+tim+"Nam ~ Dev"+trang+"] ["+tim+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I     "+trang+"] [TIME_BLOCK] ["+tim+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+xnhac+"Nam ~ Dev"+trang+"] ["+xnhac+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N    "+trang+"] [TIME_BLOCK] ["+xnhac+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+den+"Nam ~ Dev"+trang+"] ["+den+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G   "+trang+"] [TIME_BLOCK] ["+den+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+do+"Nam ~ Dev"+trang+"] ["+do+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.  "+trang+"] [TIME_BLOCK] ["+do+str(demtg)+trang+"]",end="     \r")
		sleep(0.2)
		print(trang+"["+vang+"Nam ~ Dev"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.. "+trang+"] [TIME_BLOCK] ["+vang+str(demtg)+trang+"]",end="       \r")
		sleep(0.2)
		print(trang+"["+vang+"Nam ~ Dev"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G..."+trang+"] [TIME_BLOCK] ["+vang+str(demtg)+trang+"]",end="      \r")
	print(trang+" ĐANG LÀM JOB TDS", end="                             \r")
def LoadJob(delay):
...
def NhapTds():
	while True:
		if os.path.exists('NamDev_TokenTDS.txt'):
			with open('NamDev_TokenTDS.txt', 'r') as f:
			...
			if chon == '1':
				...
				os.remove('NamDev_TokenTDS.txt'); khang(34)
			else:
				print(do+'LỰA CHỌN KHÔNG XÁC ĐỊNH.'); khang(34); continue
		if not os.path.exists('NamDev_TokenTDS.txt'):
			while True:
				khang(34)
				...
				if "error" in login:
					...
					user = login["user"]
					with open('NamDev_TokenTDS.txt', 'w') as f:
...
def LuuCookie():
	while True:
		if os.path.exists('NamDev_CokieFB.txt'):
			...
			chon = input(edit+'VUI LÒNG NHẬP LỰA CHỌN: '+trang)
			if chon == '1':
				with open('NamDev_CokieFB.txt', 'r') as f:
					list = json.loads(f.read())
					break
			elif chon == '2':
				os.remove('NamDev_CokieFB.txt'); khang(34)
			else:
				print(do+'LỰA CHỌN KHÔNG XÁC ĐỊNh.'); khang(34); continue
		if not os.path.exists('NamDev_CokieFB.txt'):
			list = NhapCookieFb()
			with open('NamDev_CokieFB.txt', 'w') as f:
				json.dump(list, f)
			break
	return list
def main():
  ...
  #banner()
	...
	while True:
		if len(listck) == 0:
			...
			listck = NhapCookieFb()
			with open('NamDev-Cookie-Page-Fb-tds.txt', 'w') as f:
				json.dump(listck, f)
		with open('NamDev-Cookie-Page-Fb-tds.txt', 'w') as f:
			json.dump(listck, f)
		for cookie in listck:
			...
			try:
				...
				listck.remove(cookie)
				os.remove('NamDev-Cookie-Page-Fb-tds.txt')
main()